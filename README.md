...
This project is open for anyone who wants to clone it and create their own version. If you just want the files and don't want to make further changes, follow the steps below to get a copy in your computer:
...
2 - You'll be redirected to the page bellow, where the red square shows the repository and the branch you want the changes implemented, and the blue one shows the repository and the branch from where the changes will come from. Give a title and a description for your pull request, and click on "Create pull request".
![New pull request page](/assets/readme-imgs/step4.png)

3 - I will analyse your proposal and if we agree, I will merge your pull request.
